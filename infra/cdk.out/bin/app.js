...
const identity = new identity_stack_1.IdentityStack(app, 'VideoGithubOidc', {});
const core = new core_stack_1.CoreStack(app, 'VideoCore', {});
const compute = new compute_stack_1.ComputeStack(app, 'VideoCompute', {
    mediaBucket: core.mediaBucket
});
new workflow_stack_1.WorkflowStack(app, 'VideoWorkflow', {
    mediaBucket: core.mediaBucket,
